...
| **Documentos relacionados** | `docs/diseno-arquitectura.md` (v1.1) — §12 · `docs/modulos/README.md` (v1.0) |
| **Esquema BD (referencia)** | `ops` |
| **Feature flag** | `features.incidencias` (definido en `docs/diseno-arquitectura.md` §18) |
| **Permisos del catálogo** | `incidencias.leer` · `incidencias.crear` **[P]** · `incidencias.asignar` · `incidencias.registrar_costo` **[P]** · `incidencias.cerrar` · `incidencias.visitas.programar` |
